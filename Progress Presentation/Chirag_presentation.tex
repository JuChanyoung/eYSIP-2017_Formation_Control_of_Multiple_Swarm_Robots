...
\begin{frame}{Task Accomplished}
	...
	\begin{itemize}
		\item The robot can turn and move towards the required location using a P controller for differential drive\\	\includegraphics[scale =.3]{images/snip0.png}\includegraphics[scale =.3]{images/snip1.png}\\
	\end{itemize}
\end{frame}
